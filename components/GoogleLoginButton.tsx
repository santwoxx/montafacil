...
export function GoogleLoginButton() {
  ...
  async function entrar() {
    if (!firebaseAuth) {
      setErro(
        "Login com Google ainda não foi configurado nesta implantação (faltam as variáveis NEXT_PUBLIC_FIREBASE_* — veja o .env.example). Use e-mail e senha por enquanto."
      );
      return;
    }
    setErro(null);
  ...
  return (
    <div>
      ...
      <button
        ...
        onClick={entrar}
        disabled={carregando}
        title={firebaseConfigured ? undefined : "Configure as variáveis NEXT_PUBLIC_FIREBASE_* para ativar"}
