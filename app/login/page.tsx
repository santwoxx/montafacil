      ...
      <div className="hidden w-1/2 flex-col justify-between bg-navy p-12 text-white lg:flex relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <div className="leading-tight">
            <p className="text-2xl font-bold uppercase tracking-widest font-display">MontaFácil</p>
        ...
        <p className="relative z-10 text-xs text-slate-500">
          © {new Date().getFullYear()} MontaFácil. Todos os direitos reservados.
        </p>
      </div>
      ...
      <div className="flex w-full flex-col items-center justify-center bg-background px-4 lg:w-1/2">
        <div className="w-full max-w-sm">
          <div className="mb-8 text-center lg:hidden">
            ...
            <h1 className="text-2xl font-bold font-display uppercase text-navy">MontaFácil</h1>
